    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-4">
            <div className="absolute inset-0 bg-gradient-to-br from-red-500/5 to-transparent rounded-lg pointer-events-none" />
            <div className="relative">
              <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex items-start gap-4 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 text-sm text-gray-400 mb-2">
                          ...
                          <span>•</span>
                          <span className={`px-2 py-0.5 border rounded-lg text-xs ${getStatusColor(transaction.status)}`}>
                            {transaction.status}
                          </span>
                        </div>
